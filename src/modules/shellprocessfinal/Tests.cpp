...
QTEST_GUILESS_MAIN( ShellProcessFinalTests )

using CommandList = Calamares::CommandList;
using std::operator""s;

ShellProcessFinalTests::ShellProcessFinalTests() {}

ShellProcessFinalTests::~ShellProcessFinalTests() {}

void
ShellProcessFinalTests::initTestCase()
{
}

void
ShellProcessFinalTests::testProcessListSampleConfig()
{
    ::YAML::Node doc;

    QString filename = QStringLiteral( "shellprocessfinal.conf" );
...
void
ShellProcessFinalTests::testProcessListFromList()
{
...
void
ShellProcessFinalTests::testProcessListFromString()
{
    YAML::Node doc = YAML::Load( R"(---
script: "ls /tmp"
)" );
...
void
ShellProcessFinalTests::testProcessFromObject()
{
    YAML::Node doc = YAML::Load( R"(---
script:
    command: "ls /tmp"
...
void
ShellProcessFinalTests::testProcessListFromObject()
{
    YAML::Node doc = YAML::Load( R"(---
script:
    - command: "ls /tmp"
...
void
ShellProcessFinalTests::testRootSubstitution()
{
    YAML::Node doc = YAML::Load( R"(---
script:
    - "ls /tmp"
